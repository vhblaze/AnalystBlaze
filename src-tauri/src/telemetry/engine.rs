...
fn backend_sample_details(sample: &TelemetrySample, privacy: TelemetryPrivacyPolicy) -> Value {
    ...
    let mut details = json!({
        ...
        "energy_components_covered": sample.energy_components_covered,
        "energy_margin_note": sample.energy_margin_note,
...
mod tests {
    ...
    fn sample_with_context(context_state: Value, details: Value) -> TelemetrySample {
        TelemetrySample {
            ...
            energy_components_covered: Vec::new(),
            energy_margin_note: None,
