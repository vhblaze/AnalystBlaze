import { Activity, ChevronRight, CreditCard, ExternalLink, LayoutDashboard, LogIn, LogOut, Settings, Sparkles, UserCog } from "lucide-react";
...
const items: { key: ViewKey; labelKey: string; icon: typeof Activity; hint: string }[] = [
  ...
  { key: "settings", labelKey: "nav.settings", icon: Settings, hint: "04" },
];
